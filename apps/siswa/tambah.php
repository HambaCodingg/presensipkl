...
if (isset($_POST['tambah_siswa'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($kodeTerbesar) {
            ...
            $urutan++;
            $kode_pengguna = "M" . str_pad($urutan, 3, "0", STR_PAD_LEFT);
        } else {
            $kode_pengguna = "M001";
        }
        ...
        // ================== Insert ke tbl_user ==================
        $password_default = md5("123456"); // password default
        $level            = "Siswa";

        $sql_user = "INSERT INTO tbl_user (kode_pengguna, username, password, level) 
                     VALUES ('$kode_pengguna', '$email', '$password_default', '$level')";
        ...
        // ================== Commit / Rollback ==================
        if ($simpan_pengguna && $simpan_siswa) {
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="date" name="mulai_pkl" class="form-control" required>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
